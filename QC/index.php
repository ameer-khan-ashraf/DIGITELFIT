...
?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">QC Dashboard</h1>
          </div>
        ...
        <div class="card-body table-wrapper-scroll-y my-custom-scrollbar" style="height:40vh;">
            ...
            <table class="table table-bordered table-striped ">
                ...
                <tr>
                    ...
                    <th style="min-width:200px;"scope="col">QC status</th>
                ...
                <tbody>
                    ...
                    <td>
                        <div class="form-group">
                            <select name="qcstatus" class="form-control">
        ...
        <div class="card-body table-wrapper-scroll-y my-custom-scrollbar" style="height:50vh;">
            ...
            <table class="table table-bordered table-striped ">
                ...
                <tbody>
                    ...
                    <td>
                    <button type="submit" name="update-mrint" class="btn btn-primary">Update</button>
                    </td>
                    </form>
                    </tr>
                    <?php
